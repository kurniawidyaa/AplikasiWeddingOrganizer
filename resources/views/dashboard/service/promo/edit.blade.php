          ...
          <div class="col col-lg-6 col-md-6">
            <div class="card">
              ...
              <div class="card-body">
                ...
                @endif
                <form action="{{ route('owner.promo.update', $promo->id) }}" method="post">
                  @csrf
                  @method('PUT')
                  <div class="form-group">
                    ...
                    <select name="service_id" id="service_id" class="form-control @error('service_id') is-invalid @enderror">
                      ...
                      @foreach($service as $service)
                        @if (old('service_id', $promo->service_id) == $service->id)
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="starting_price" id="starting_price" class="form-control" value="{{ old('starting_price', $promo->starting_price) }}">      
                  </div>
                  <div class="row">
                    <div class="col">
                      <div class="form-group">
                        <label for="percent_discount">Diskon Persen</label>
                        <input type="text" name="percent_discount" id="percent_discount" class="form-control" value={{ old('percent_discount', $promo->percent_discount) }}>
                      </div>
                    </div>
                    <div class="col">
                      <div class="form-group">
                        <label for="nominal_discount">Diskon Nominal</label>
                        <input type="text" name="nominal_discount" id="nominal_discount" class="form-control" value={{ old('nominal_discount', $promo->nominal_discount) }}>
                      </div>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="final_price">Harga Akhir</label>
                    <input type="text" name="final_price" id="final_price" class="form-control" value={{ old('final_price', $promo->final_price) }}>
                  </div>
                  <div class="form-group">
