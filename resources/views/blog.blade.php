          ...
          <div class="row">
            ...
            <div class="col-lg-8 entries">
              ...
              <article class="entry">
                ...
                <div class="entry-img">
                  @if ($post->thumbnail)
                      <img src="{{ asset('/storage/' . $post->thumbnail) }}" alt="{{ $post->PostCategory->name }}" class="img-fluid">
                  @else
                      <img src="https://source.unsplash.com/1000x500?{{ $post->PostCategory->name }}" alt="" class="img-fluid">
                  @endif
                </div>
                ...
                <div class="entry-meta">
                  <ul>
                    ...
                    <li class="d-flex align-items-center"><i class="bi bi-chat-dots"></i> <a href="/blog?postCategory={{ $post->PostCategory->slug }}">{{ $post->PostCategory->name }}</a></li>
                  </ul>
                </div>
              ...
              <div class="sidebar">
                ...
                <div class="sidebar-item categories">
                  <ul>
                    ...
                    <li><a href="/blog?postCategory={{ $cat->slug }}" alt="{{ $cat->name }}">{{ $cat->name}} <span>({{ $cat->count() }})</span></a></li>  
                    @endforeach 
                  </ul>
